...
def mj_play(data, fr):
    m = mujoco.MjModel.from_xml_path('/home/mycode/exp-humanoid/legged_gym/resources/robots/g1/g1_29dof.xml')
...
def main():
    ...
    # 根目录路径
    root_dir = '/home/mycode/data/Retargeted_AMASS_for_robotics/g1'
